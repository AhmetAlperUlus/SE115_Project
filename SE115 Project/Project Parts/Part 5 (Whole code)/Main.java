...
public class Main {
    ...
    public static int biggestDailySwing(int month) {
        ...
        for (int i = 0 ; i < DAYS ; i++) {
            int today = totalProfitOnDay(month, i + 1);
            int yesterday = totalProfitOnDay(month, i);
    ...
    public static String compareTwoCommodities(String c1, String c2) {
        int cIndex1 = getCommoditiesIndex(c1);
        int cIndex2 = getCommoditiesIndex(c2);
        ...
        long differance = Math.abs(total1 - total2);
        if (total1 > total2) return c1 + " is better by " + differance;

        else if (total2 > total1) return c2 + " is better by " + differance;
